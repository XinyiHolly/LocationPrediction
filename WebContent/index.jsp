	...
	<div id="select">
		<table>
			<tr>
				...
				<td><select id="clusterselect" name="clusterselect" onchange="ajaxGet2()">
						<option value="ActivityCluster" selected="selected">ActivityCluster</option>
						<option value="MDBSCAN">MDBSCANCluster</option>
				...
				<td><select id="labelselect" name="labelselect" onchange="ajaxGetLabelMode()">
						<option value="MDBSCAN">MDBSCANCluster</option>
						<option value="Activity" selected="selected">ActivityCluster</option>
				</select></td>
